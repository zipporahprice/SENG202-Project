...
public class RouteTest {
    ...
    void testConstructor() {
        ...
        Assertions.assertEquals(points, route.route,
                "The route's points should match the provided points.");
    }
    ...
    void testToJsonArray() {
        ...
        Assertions.assertEquals(expectedJson, route.toJsonArray(),
    ...
    void testRoutesToJsonArray() {
        ...
        String expectedJson = "[[{\"lat\": 40.712800, \"lng\": -74.006000}], "
                + "[{\"lat\": 34.052200, \"lng\": -118.243700}]]";
        Assertions.assertEquals(expectedJson, Route.routesToJsonArray(routes),
                "The JSON output should match the expected format for multiple routes.");
    }
}
